...
public class FragmentStatisticsTabs extends Fragment {

String mode;
    public static FragmentManager fm;
    public static int pos;

    public FragmentStatisticsTabs() {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        fm.beginTransaction().replace(R.id.frame_vvi_tabs, new StatisticsFragment(),"StatisticsFragment").commit();
        fm.beginTransaction().addToBackStack(null);
    }

    public static void callGraph(){
        fm.beginTransaction().replace(R.id.frame_vvi_tabs, new StatisticsGraphFragment(),"StatisticsGraphFragment").commit();
        fm.beginTransaction().addToBackStack(null);
    }
